...
const PLUGIN_LIB_NANOS = { 'wBAN': Resolve('elfs/plugin_nanos.elf') };
const PLUGIN_LIB_NANOX = { 'wBAN': Resolve('elfs/plugin_nanox.elf') };
const PLUGIN_LIB_NANOSP = { 'wBAN': Resolve('elfs/plugin_nanosp.elf') };
